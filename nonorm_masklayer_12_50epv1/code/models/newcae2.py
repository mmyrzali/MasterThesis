...
class YourNet(nn.Module):
    def __init__(self, input_channels, use_masklayer, masklayer_code_sizes,latent=80,mode=None):
        super().__init__()
        ...
        self.bottleneck_size = 80  # Put here the number of features in the tensor you give as input to MaskLayer
